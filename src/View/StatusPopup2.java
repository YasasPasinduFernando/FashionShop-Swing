 ...
 */
public class StatusPopup2 extends javax.swing.JFrame {
    Customer customer;
    /**
    ...
    public StatusPopup2(Customer customer) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(Deliverdbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 120, 110, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StatusPopup2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StatusPopup2().setVisible(true);
            }
        });
    }
