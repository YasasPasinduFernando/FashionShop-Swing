 ...
 */
public class AllOrdersByAmount extends javax.swing.JFrame {

    /**
     * Creates new form BestInCustomer
     */
    public AllOrdersByAmount() {
        initComponents();
    ...
    public void tableData(){
        ...
        Customer [] ar= Controller.allOdersByAmount();
        for (int i = 0; i < ar.length; i++) {
            Object [] arr = {ar[i].getId(),ar[i].getPhoneNumber(),ar[i].getSize(),
                ar[i].getQty(),ar[i].getAmount(),ar[i].getStatus()};
            dtm.addRow(arr);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AllOrdersByAmount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AllOrdersByAmount().setVisible(true);
            }
        });
    }
